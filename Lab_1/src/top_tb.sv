...
module Testbench;
    ...
    initial begin
        ...
        master_inst.apb_write(32'h00000008, 32'h55534143); // USAC
        #50;

        // 4. Запись по адресу 0xC значения имя  
        $display("TEST 4: Writing name to address 0xC");
        master_inst.apb_write(32'h0000000C, 32'h44414E49); // DANI
        #50;
        ...
        $display("VERIFICATION: Read addr 0x8 = 0x%08h (Expected: 0x55534143)", read_data);
        if (read_data == 32'h55534143) 
            $display("PASS: Data matches expected value!");
        else 
            $display("FAIL: Data mismatch!");
        #20;
        ...
        $display("VERIFICATION: Read addr 0xC = 0x%08h (Expected: 0x44414E49)", read_data);
        if (read_data == 32'h44414E49) 
            $display("PASS: Data matches expected value!");
        else 
            $display("FAIL: Data mismatch!");
        #20;
